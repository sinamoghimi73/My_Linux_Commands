...
apt-get install -y libssl-dev libusb-1.0-0-dev libudev-dev pkg-config libgtk-3-dev libglfw3-dev libgl1-mesa-dev libglu1-mesa-dev python3-dev libpcl-dev
cd /home/aida/Downloads/REALSENSE/librealsense
...
rm -rf build
mkdir build
cd /home/aida/Downloads/REALSENSE/librealsense/build
